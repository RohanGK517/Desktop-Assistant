...
def Action(send) :   
    ...
    if "what is your name" in   data_btn :
      speak.speak("my name is rohan the virtual Assistant")  
      return "my name is rohans the virtual Assistant"
        ...
        speak.speak("google is opened for you sir")  
        return "google is opened for you sir"

    elif 'youtube' in data_btn or "open youtube" in  data_btn:
        url = 'https://youtube.com/'
        webbrowser.get().open(url)
        speak.speak("YouTube is opened for you sir") 
        return "YouTube is opened for you sir"    
